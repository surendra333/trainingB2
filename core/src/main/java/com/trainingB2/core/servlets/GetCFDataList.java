...
@Component(service=Servlet.class,
           property={
                   ...
                   "sling.servlet.paths="+ "/bin/api/GettingCfList",
                   "sling.servlet.extensions=" + "json"
           })
@ServiceDescription("Path Based Servlet in Content Fragment")
public class GetCFDataList extends SlingSafeMethodsServlet {

    private static final long serialVersionUID = 1L;
 private static final Logger LOG =  LoggerFactory.getLogger(GetCFDataList.class);
    
    @Reference
    private ContentFragmentDataList contentFragmentDataList;
    ...
    protected void doGet(final SlingHttpServletRequest req,
        ...
        JSONObject data = contentFragmentDataList.getContentFragmentList(cflist,req,node);
        LOG.info("data"+data);
       if(data!=null){

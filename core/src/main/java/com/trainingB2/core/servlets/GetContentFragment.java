...
@Component(service=Servlet.class,
           property={
                   ...
                   "sling.servlet.paths="+ "/bin/api/GetCF",
...
public class GetContentFragment extends SlingSafeMethodsServlet {
 ...
 private static final Logger LOG =  LoggerFactory.getLogger(GetContentFragment.class);
    ...
    protected void doGet(final SlingHttpServletRequest req,
        ...
        JSONObject data = contentFragmentCrudOperations.getContentFragment(cf);
        LOG.info("data"+data);
       if(data!=null){
